...
`codex/windows-zero-approval-smoke-v3`; do not move it after smoke evidence is
collected.
...
git rev-parse origin/codex/windows-zero-approval-smoke-v3
...
```bash
git diff --exit-code origin/main origin/codex/windows-zero-approval-smoke-v3 -- \
