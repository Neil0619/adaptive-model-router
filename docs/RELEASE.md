...
`codex/windows-zero-approval-smoke-v2`; do not move it after smoke evidence is
collected.
...
git rev-parse origin/codex/windows-zero-approval-smoke-v2
...
```bash
git diff --exit-code origin/main origin/codex/windows-zero-approval-smoke-v2 -- \
