...
export const REASON_CODES = [
  ...
  "HOST_AGENT_LIMIT_REACHED",
  "HOST_CAPACITY_RECHECK_REQUIRED",
  "HOST_CAPACITY_TEMPORARY_BUSY",
  "HOST_CAPACITY_RETRY_EXHAUSTED",
  "CHILD_MAINTENANCE_PENDING",
  "HOST_CAPACITY_EVIDENCE_UNPROVEN",
  "HOOK_TRUST_REQUIRED",
  "HOST_HOOK_SET_MISMATCH",
  "HOST_HOOK_STATUS_UNAVAILABLE",
  "HOST_HOOK_DISPATCH_NOT_OBSERVED",
  "HOST_LIFECYCLE_ROUND_TRIP_UNPROVEN",
  "HOST_LIFECYCLE_QUALIFICATION",
  "HOST_LIFECYCLE_QUALIFICATION_FAILED",
  "RUNTIME_CANDIDATE_QUALIFICATION_PENDING",
  "CATALOG_UNAVAILABLE",
  "STORAGE_UNAVAILABLE",
  "EXPLICIT_OVERRIDE",
  "ONCE_OVERRIDE",
  ...
  "DELEGATION_BUSY",
  "LOW_DISK_FALLBACK",
  "DISK_STATE_UNAVAILABLE",
  "CONTEXT_PACKAGE_TOO_LARGE",
  "ROUTER_CHILD_STORAGE_LIMIT",
  "ROUTER_GLOBAL_PENDING_LIMIT",
  "ROUTER_CHILD_STORAGE_UNTRUSTED",
];
